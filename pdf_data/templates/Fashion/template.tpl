    ...
    <?php while ( $loop->have_posts() ){ ?>
        ...
        <div class="product">
            ...
            <?php if(!empty($special)){ ?>
                <div class="price">
                    <img src="../wp-content/plugins/pdfcatalog/pdf_data/templates/Fashion/img/price_bg.png"/>
                    <div style="margin-top: -32px;"><s><?php echo wc_price($product->get_regular_price()); ?></s></div>
                </div>
                <div class="special">
                    <img src="../wp-content/plugins/pdfcatalog/pdf_data/templates/Fashion/img/new_price_bg.png"/>
