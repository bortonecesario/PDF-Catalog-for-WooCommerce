<?php           
    ...
    include_once(PDF_CATALOG__PLUGIN_DIR.'pdf_data/utils/Logger.php');

    if(!class_exists('mPDF')){
        include_once(PDF_CATALOG__PLUGIN_DIR.'pdf_data/mpdf_lib/mpdf.php');
    }

    if (!class_exists('fpdi_pdf_parser')) {
            include_once(PDF_CATALOG__PLUGIN_DIR.'pdf_data/mpdf_lib/vendor/setasign/fpdi/fpdi_pdf_parser.php');
    }
